...
const Nopage = () => {
  return (
    <div className={styles.nopagebody}>
      <div className={styles.background}>
        <div className={styles.ground}></div>
      </div>
      <div className={styles.nopagecont}>
        <div className={styles.leftsection}>
          <div className={styles.innercontent}>
            ...
            <div className=" flex justify-center m-4">
              <Link href="/">
                <h2 className="w-fit hover:bg-slate-400 text-slate-100 border border-black rounded p-3">
                  <i className="bi bi-arrow-left-short text-xl"></i> Back to
                  Home page
                </h2>
              </Link>
            </div>
        ...
        <div className={styles.rightsection}>
          ...
          S149.306,67.362,149.306,71.528z"
              ...
              <circle
                className={styles.lamplightglow}
                fill="url(#SVGID_1_)"
                cx="119.676"
                cy="44.22"
                r="65"
